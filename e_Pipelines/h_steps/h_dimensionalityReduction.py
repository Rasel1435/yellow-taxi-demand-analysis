...
def ReduceDimensionality(
    ...
    try:
        ...
        pca_path = f"d_Data/artifacts/pca_model_{version_stamp}.joblib"
...
if __name__ == "__main__":
    df = pd.read_csv('/media/sheikh/F262ADC762AD90C1/backup/ML/yellow-taxi-demand-analysis/d_Data/processed/f_2025_hourly_all_selected_features_standardized.csv')
